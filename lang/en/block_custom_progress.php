...
$string['config_header_custom'] = 'Custom';
...
<p>There can be multiple instances of the Progress Bar block. You may use different Progress Bar blocks to monitor different sets of activities or resources. For instance you could track custom_progress in assignments in one block and quizzes in another. For this reason you can override the default title and set a more appropriate block title for each instance.</p>
';
...
<p>The purpose of this block is to encourage students to manage their time effectively. Each student can monitor their custom_progress in completing the activities and resources you have created.</p>
<p>On the configuration page you will see a list of all the modules that you have created which can be monitored by the Progress Bar block. Modules will only be monitored and appear as a small square in the custom_progress bar if you select Yes to monitor the module.</p>
';
...
$string['why_show_precentage'] = 'Why show a custom_progress percentage to students?';
$string['why_show_precentage_help'] = '
<p>It is possible to show an overall percentage of custom_progress to students.</p>
<p>This is calculated as the number of items complete divided by the total number of items in the bar.</p>
<p>The custom_progress percentage appears until the student mouses over an item in the bar.</p>
';
...
$string['no_events_config_message'] = 'There are no activities or resources to monitor the custom_progress of. Create some activities and/or resources then configure this block.';
...
$string['pluginname'] = 'Custom Progress Bar';
...
$string['custom_progress'] = 'Progress';
$string['custom_progressbar'] = 'Custom Progress Bar';
$string['custom_progressbadge'] = 'Custom Progress Badge';

// For capabilities.
$string['custom_progress:overview'] = 'View course overview of Progress bars for all students';
$string['custom_progress:addinstance'] = 'Add a new Progress Bar block';
$string['custom_progress:myaddinstance'] = 'Add a Progress Bar block to My home page';
$string['custom_progress:showbar'] = 'Show the bar in the Progress Bar block';
...
$string['enablecustom'] = 'Use customs';
$string['usecustom'] = 'When set to yes, you must provide customizing.';
$string['usecustom_help'] = 'When set to yes, you must provide provide customizing.';
